...
const Register = () => {
    ...
    return (
        <Card  p={[1, 5, 8]} boxSize={[300, 400, 700]} h={550} bg={'gray.300'} borderRadius={'lg'} alignItems={'center'} display={'flex'} flexDirection={'column'}>
        ...
        <FormControl>
            ...
            <Input size={['md', 'lg']} required type="text" bg={'gray.300'} focusBorderColor="blue.800" borderColor={"black"} />
        </FormControl>
        </CardBody>
