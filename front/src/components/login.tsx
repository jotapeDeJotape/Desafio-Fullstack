...
const Login = () => {
    ...
    return (
        <Card  p={[2, 5, 8]} boxSize={[450, 400, 450]} h={[420, 500, 500]} bg={'gray.300'} borderRadius={'lg'} alignItems={'center'} display={'flex'} flexDirection={'column'}>
        <CardHeader fontFamily={'heading'} fontSize={30}>Entre Na Sua Conta</CardHeader>
        <CardBody boxSize={'100%'} gap={[1, 3, 5]} display='flex' flexDirection={'column'}>
        <FormControl isRequired isInvalid={emailError}>
            <FormLabel fontFamily={'monospace'} fontSize='20px'>E-mail</FormLabel>
        ...
        <FormControl isRequired isInvalid={passwordError}>
            <FormLabel fontFamily={'monospace'} fontSize='20px'>Senha</FormLabel>
            <InputGroup>
